...
function woo_change_order_received_text($str, $order) {
    $new_str = $str . '' . esc_html__('Go back to', 'adforest') . '<strong class="woo_added"> <a href="' . home_url('/') . '">  '.esc_html__('Home','adforest').'  </a></strong> or  <strong class="woo_added"><a href = "' . get_permalink(get_option('woocommerce_myaccount_page_id')) . '">' . esc_html__('My account', 'adforest') . ' </a></strong>';
    return $new_str;
}
