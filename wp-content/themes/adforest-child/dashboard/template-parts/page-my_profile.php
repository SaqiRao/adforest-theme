                ...
                <div class="col-lg-8 col-xl-9">
                    <div class="profile-content-right profile-right-spacing py-5">
                        <ul class="nav nav-tabs px-3 px-xl-5 nav-style-border" id="myTab" role="tablist">
                            ...
                            <?php  
                        $package_enable =  isset($adforest_theme['sb_user_packages_enable_option']) ? $adforest_theme['sb_user_packages_enable_option'] : "";
                        if(isset($package_enable) && $package_enable == "1"){
                           ?>
                            <button type="button" class="btn btn-primary user-package-btn" data-toggle="modal" data-target="#myModal1"> User Package</button>
                            <?php
                                }
                            ?>
                        </ul>
...
?>
                       ...
                       <div class="modal-dialog">
                           <div class="modal-content">
                               <!-- Modal Header -->
                               <div class="modal-header">
                                   <h4 class="modal-title">User Package</h4>
                                   <button type="button" class="close" data-dismiss="modal">&times;</button>
                               </div>
                               <div class="modal-body">
                                   <form id="premium-badge-form" data-action="submit_premium_badge">
                                   <?php
                                   ...
                                   if ($terms && !is_wp_error($terms)) {
                                       ?>
                                       <label for="selected_premium_badge">Select Premium Badge:</label>
                                       <select name="selected_premium_badge" id="selected_premium_badge">
                                            <option value="">Select a premium badge</option>
                                            <?php
                                            foreach ($terms as $term) {
                                                $term_price = get_term_meta($term->term_id, 'term_price', true);
                                                $currency_symbol = get_woocommerce_currency_symbol();

                                                // Check if the price is greater than or equal to 0 before displaying the currency symbol
                                                if ($term_price >= 0) {
                                                    $display_price = esc_html($currency_symbol . $term_price);
                                                } else {
                                                    $display_price = esc_html($currency_symbol . '0'); // Display '0' when price is less than 0
                                                }
                                                ?>
                                                <option value="<?php echo esc_attr($term->slug); ?>">
                                                    <?php echo esc_html($term->name); ?> - Price: <?php echo $display_price; ?>
                                                </option>
                                                <?php
                                            }
                                            ?>
                                   ...
                                   ?>
                                   <div class="form-btns">
                                       <button type="button" class="btn btn-theme submit-btn" id="submit-premium-badge">Submit</button>
