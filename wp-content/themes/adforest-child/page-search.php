...
$ad_cat_id = isset($_GET['ad_cat_id']) ? $_GET['ad_cat_id'] : '';
...
if($ad_cat_sub_sub_sub_sub){
     $cat_id = $ad_cat_sub_sub_sub_sub;
} elseif ($ad_cat_sub_sub_sub !== '') {
    $cat_id = $ad_cat_sub_sub_sub;
} elseif ($ad_cat_sub_sub !== '') {
    $cat_id = $ad_cat_sub_sub;
} elseif ($ad_cat_sub !== '') {
    $cat_id = $ad_cat_sub;
} elseif ($ad_cat_id !== '') {
    $cat_id = $ad_cat_id;
...
require trailingslashit(get_stylesheet_directory()) . 'template-parts/layouts/search/search-' . $search_layout . '.php';
